...
const plans: Plan[] = [
  ...
  },
  {
    ...
    audience: "Freelancers & solo operators",
    monthly: 5,
    monthlyStrike: 7,
    yearly: 48,
    yearlyStrike: 84,
  ...
  },
  {
    ...
    audience: "Unlimited seats, white-glove",
    monthly: 50,
    monthlyStrike: 65,
    yearly: 480,
    yearlyStrike: 780,
...
const rows: Row[] = [
  { label: "Drag-and-drop editor", values: [true, true, true, true] },
  { label: "Live email preview", values: [true, true, true, true] },
  { label: "Saved signature designs", values: ["up to 3", "1", "up to 12", "Unlimited"] },
  { label: "Template library access", values: ["10 starters", "All 31", "All 31 + updates", "All 31 + private templates"] },
  { label: "Custom-built templates", values: ["—", "1", "10", "Unlimited"] },
  { label: "Profile & company photo uploads", values: [true, true, true, true] },
  { label: "Auto-fetch branding from a website", values: [true, true, true, true] },
  { label: "Copy-to-clipboard install", values: [true, true, true, true] },
  { label: "Gmail, Outlook & Apple Mail export", values: [true, true, true, true] },
  { label: "Shareable install link", values: [true, true, true, true] },
  { label: "Bulk send via email + CSV", values: [false, false, "Up to 50 seats", "Unlimited"] },
  { label: "Push to Google Workspace (1-click)", values: [false, false, true, true] },
  { label: "Push to Microsoft 365 (1-click)", values: [false, false, true, true] },
  { label: "Per-member address & social overrides", values: [false, false, true, true] },
  { label: "Marketing banners & CTA buttons", values: [false, true, true, true] },
  { label: "Click tracking & signature analytics", values: [false, false, false, true] },
  { label: "A/B test campaign banners", values: [false, false, false, true] },
  { label: "White-label & custom domain", values: [false, false, false, true] },
  { label: "SSO + role-based permissions", values: [false, false, false, true] },
  { label: "Priority chat support", values: [false, false, true, true] },
  { label: "Dedicated onboarding manager", values: [false, false, false, true] },
];
